      ...
      <div className="min-h-screen bg-[#FAFAFA]">
        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6 animate-fadeIn">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-2xl font-bold text-[#1F2933] tracking-tight">Assigned Tickets Queue</h1>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <Card className="shadow-card">
              <CardBody className="p-4">
                <p className="text-xs font-semibold text-[#9AA5B1] uppercase tracking-wider">Assigned</p>
          ...
          {error ? (
            <Card className="p-8 text-center space-y-3 bg-red-50/50 border-red-200">
              ...
              <Button variant="danger" size="sm" onClick={fetchAssignedTickets}>
                Retry
              </Button>
            </Card>
          ) : loading ? (
            ...
            <EmptyState
              ...
              description={
                searchTerm || statusFilter !== "all" || priorityFilter !== "all"
                  ? "No tickets in your queue match the selected search or filter criteria."
                  : "You currently have no tickets assigned to your queue. All caught up!"
              }
            />
          ) : (
            <div className="space-y-4">
