...
import { Plus, Search, Filter, RefreshCw, AlertCircle, FileText, Clock, CheckCircle2 } from "lucide-react";
...
export default function MyTicketsPage() {
  ...
  const fetchTickets = useCallback(async () => {
    ...
    try {
      const data = await apiClient<Ticket[]>("/tickets");
      setTickets(data);
    } catch (err: unknown) {
      ...
      <div className="min-h-screen bg-[#FAFAFA]">
        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6 animate-fadeIn">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-2xl font-extrabold text-gray-900 tracking-tight">My Support Tickets</h1>
              <p className="text-sm text-gray-600 font-medium">
                Track status, review resolution progress, and respond to support agents.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Card className="border border-slate-200 shadow-card">
              <CardBody className="p-5 space-y-1.5">
                ...
                <div className="text-xs text-gray-500 font-medium">All logged complaints</div>
              </CardBody>
            </Card>
            ...
            <Card className="border border-slate-200 shadow-card">
              <CardBody className="p-5 space-y-1.5">
                ...
                <div className="text-xs text-gray-500 font-medium">Currently being processed</div>
              </CardBody>
            </Card>
            ...
            <Card className="border border-slate-200 shadow-card">
              <CardBody className="p-5 space-y-1.5">
                ...
                <div className="text-xs text-gray-500 font-medium">Successfully completed</div>
              </CardBody>
            </Card>
          </div>
          ...
          {loading ? (
            ...
            <EmptyState
              title={searchTerm || statusFilter !== "all" || priorityFilter !== "all" ? "No matching tickets" : "No tickets yet"}
              description={
                searchTerm || statusFilter !== "all" || priorityFilter !== "all"
                  ? "Try clearing or adjusting your search filters to find tickets."
                  : "You haven't submitted any support requests yet. Create a ticket to get help from our support team."
              }
              action={
                searchTerm || statusFilter !== "all" || priorityFilter !== "all" ? (
                  <Button
